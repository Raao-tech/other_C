...
/*   Updated: 2025/08/10 23:31:33 by rafael           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
    ...
    while (!WindowShouldClose())
    {
        ...
        BeginDrawing(); 
			//limpia el fondo y colorealo del color RAYWHITE
            ClearBackground(RAYWHITE); 
			//dibuja el texto dado en parametros
            DrawText("Felicidades! Acabas de comenzar tu primer videojuego!", 150, 200, 20, LIGHTGRAY);
